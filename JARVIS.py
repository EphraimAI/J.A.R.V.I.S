...
def wish():
    ...
    if hour >= 0 and hour<12:
        ...
        speak("good night I am jarvis sir. How may I help you ,Sir!")  
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login("ephraimec4@gmail.com", "EphraimEC16791710")
    server.sendmail("ephraimec4@gmail.com", to, content)
    server.close()
#for main function                               
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            stMsgs = ['Just doing my thing!i am okey ! How are you']
            ans_q = random.choice(stMsgs)
            speak(ans_q)  
        elif 'make you' in query or 'created you' in query or 'develop you' in query:
            ans_m = " For your information Ephraim Created me ! I give Lot of Thannks to you "
            print(ans_m)
            speak(ans_m)
            ...
            ex_exit = 'thanks for using me sir ,Im very tankful to you ,Good bye Sir!'
            speak(ex_exit)
            exit()    
            ...
            try:
                ...
                content = takecom()
                to = "ephraimec4@gmail.com"
                sendEmail(to, content)
                speak("Email has ben sent!")
            except Exception as e:
                print(e)
                speak("Sorry my friend ephraim, I am not able to sent this email")   
